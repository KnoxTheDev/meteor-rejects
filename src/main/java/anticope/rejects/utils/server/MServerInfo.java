...
public class MServerInfo {
    ...
    public String label;
    public long ping;
    public int protocolVersion = SharedConstants.getCurrentVersion().getProtocolVersion(); // updated method
    public String version = null;
    public List<Component> playerListSummary = Collections.emptyList(); // Text -> Component
